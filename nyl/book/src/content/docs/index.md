...
- [Rendered Manifest GitOps](/nyl/deployment-workflows/rendered-manifests/) keeps Nyl in CI and lets ArgoCD, Flux, or another reconciler sync ordinary Kubernetes YAML.
